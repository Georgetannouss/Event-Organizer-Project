...
const $router = useRouter(); // This gives you access to $route
const $route = useRoute(); // This gives you access to $route
...
function nameWithDate({ name, date }) {
...
const v$ = useVuelidate(validations(), client);
